    ...
    public class EntitiesController : ApiController
    {
        ...
        public IHttpActionResult PostEntity(Entity entity)
        {
            ...
            try
            {
                ...
                {
                    GeneralLogsController.PostGeneralLog("Entities", email, "Gateway", HttpStatusCode.BadRequest.ToString(), "PostEntity", "Invalid input", DateTime.Now, Convert.ToInt64((DateTime.Now - responseTimeStart).TotalMilliseconds));
        ...
        public IHttpActionResult PutEntity(string entity_id, Entity entity)
        {
            ...
            try
            {
                if (entity == null || entity.Name == null || entity.Endpoint == null || entity.MaxLimit < 0 || entity.EarningPercentage < 0 || entity.EarningPercentage > 100 || entity.Authentication == null)
                {
                    GeneralLogsController.PostGeneralLog("Entities", email, "Gateway", HttpStatusCode.BadRequest.ToString(), "PutEntity", "Invalid input", DateTime.Now, Convert.ToInt64((DateTime.Now - responseTimeStart).TotalMilliseconds));
                    return Content(HttpStatusCode.BadRequest, "Invalid inputs");
                }
                if (entity.Endpoint != null)
                {
        ...
        public IHttpActionResult PutEntityAuth(string entity_id,[FromBody] Authentication authentication)
        {
            ...
            try
            {
                ...
                {
                    GeneralLogsController.PostGeneralLog("Entities", email, "Gateway", HttpStatusCode.BadRequest.ToString(), "PutEntityAuth", "Invalid input", DateTime.Now, Convert.ToInt64((DateTime.Now - responseTimeStart).TotalMilliseconds));
                    return Content(HttpStatusCode.BadRequest, "Invalid inputs");
                }
